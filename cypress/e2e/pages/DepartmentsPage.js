...
//Locators
get departmentHeader(){return cy.get("#showMenuBtn + h1")}
get departmentName(){return cy.get("tbody tr:first-of-type td[data-title='Name']")}
get noRecordeLbl() { return cy.get("div.fs-4") }
get searchTxt() { return cy.get("input[name='search']") }
get addDepartmentBtn() { return cy.get("div.actions > a.export") }
get addUpdateDepartmentHeader() { return cy.get("#staticBackdropLabel") }
...
enterDepartmentName(departmentName){
  this.DepartmentNameTxt.clear().wait(1000).type(departmentName).should('have.value',departmentName);
}
getDepartment() {
