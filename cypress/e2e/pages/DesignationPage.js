...
class DepartmentsPage extends BasePage {
  ...
  get addUpdateDesignationHeader() {
  ...
  enterDesignationName(designation) {
    this.designationNameTxt
      .clear()
      .wait(1000)
      .type(designation)
      .should("have.value", designation);
  }
