...
class EmployeeDetailPage extends BasePage {
  ...
  get personalEmailInEmpDetails() {
    return cy.get("input[name='personalEmail']");
  }
  get gender() {
    return cy.get("div.custom-checkbox.small > div");
  }
  ...
  get passportNo() {
    return cy.get("input[name='passportNumber']");
  }
  get nextButton() {
  ...
  get alternateNumber() {
    return cy.get("input[name='alternateNumber']");
  }
  ...
  get alternateName() {
    return cy.get("input[name='alternateName']");
  }
  get presentAddress() {
  ...
  get nextButtonOnContactDetails() {
    return cy.get("button[class='theme-button']");
  }
  ...
  get thankYouSuccessMsg() {
    return cy.get(".fw-300");
  }
  ...
  enterPersonalEmailInEmpDetails(emailTxt) {
    this.personalEmailInEmpDetails
      .type(emailTxt)
      .should("have.value", emailTxt);
  ...
  selectRelationship(relation) {
    this.relationshipWithAlternateNo
      .select(relation)
  ...
  enterPresentAddress(presentAddress) {
    this.presentAddress
      .type(presentAddress)
      .should("have.value", presentAddress);
  ...
  validateSuccessMessage() {
    ...
    cy.contains("Your submission has been sent successfully.").should(
      "be.visible"
    );
