...
class ReimbursementPage extends BasePage {
  ...
  get reimbursementReqBtn() {
    return cy.get("div.actions > a.export");
  }
  get reimbursementFormLbl() {
    return cy.get("#assign-asset h3");
  }
  get backtoReimbursementPageBtn() {
    return cy.get("a.brand-color");
  }
  get reimbursementType_Drp() {
    return cy.get("#reimbursementType");
  }
  get invoiceNo_Txt() {
    return cy.get("input[name='invoiceNo']");
  }
  get reimbursementAmount_Txt() {
    return cy.get("input[name='reimbursementAmount']");
  }
  get comment_Txt() {
  ...
  get fromDate() {
    return cy.get("input[name='fromDate']");
  }
  get toDate() {
    return cy.get("input[name='toDate']");
  }
  get submit_Btn() {
    return cy.get("button[type='submit']");
  }
  get reset_Btn() {
    return cy.get("div button.btn");
  }
  get chooseFile() {
    return cy.get("input[type='file']");
  }
  get lastReimbursmentName() {
    return cy.get("tbody tr:last-of-type td[data-title='name']");
  }
  get lastInvoiceNo() {
    return cy.get("tbody tr:last-of-type td[data-title='invoiceNo']");
  }
  get lastRequestStatus() {
    return cy.get("tbody tr:last-of-type td[data-title='trackingStatus']");
  }
  get lastRowActionLbl() {
    return cy.get("tbody tr:last-of-type td a");
  }
  get withDrawReimbursementLbl() {
  ...
  get viewBtn() {
    return cy.get("#staticBackdropAssetwithdraw div > a");
  }
  get lastRowAction_Lbl() {
    return cy.get("tbody tr:last-of-type td p");
  }
  get itemPerPageDrp() {
  ...
  get fromPlaceTxt() {
    return cy.get("input[name='fromPlace']");
  }
  get toPlaceTxt() {
    return cy.get("input[name='toPlace']");
  }
  get vehicalTypeDrp() {
    return cy.get("#vehicleType");
  }
  get distanceTxt() {
    return cy.get("input[name='distance']");
  }
