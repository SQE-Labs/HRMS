...
class AssignManagerPage extends BasePage {
  ...
  get assigneeMangerPopupLbl() {
    return cy.get("#staticBackdropLabel");
  }
  get submitAssigneeBtn() {
    return cy.get("#staticBackdropReassignManager button[type='submit']");
  }
  get reAssigneeBtn() {
  ...
  get cancelBtn() {
    return cy.get(
      "#staticBackdropReassignManager button[type='button'].theme-button"
    );
  }
  get selectManagerDrp() {
