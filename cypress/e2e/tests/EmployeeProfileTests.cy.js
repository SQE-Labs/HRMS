...
describe("Employee Profile Tests", () => {
  ...
  it("HRMIS_3: Verify that the 'Personal Details' accordion expands, and validate the update and close functionalities.", () => {
    ...
    EmployeeProfilePage.getFieldValue("Date of Birth").should(
      "equal",
    ...
    EmployeeProfilePage.getFieldValue("Passport Number").should(
      "equal",
      testData.EmployeePersonalData.PassportNumber
    );
    EmployeeProfilePage.getFieldValue("PAN Number").should(
      "equal",
      testData.EmployeePersonalData.PanNumber
    );
    EmployeeProfilePage.getFieldValue("Present Address").should(
      "equal",
      testData.EmployeePersonalData.PresentAddress
    );
    EmployeeProfilePage.getFieldValue("Blood Group").should(
      "equal",
      testData.EmployeePersonalData.BloodGroup
    );
    EmployeeProfilePage.getFieldValue("Gender").should(
      "equal",
      testData.EmployeePersonalData.Gender
    );
    EmployeeProfilePage.getFieldValue("Marital Status").should(
      "equal",
      testData.EmployeePersonalData.MaritalStatus
    );
    EmployeeProfilePage.getFieldValue("Alternate Number").should(
      "equal",
      testData.EmployeePersonalData.AlternateNumber
    );
    EmployeeProfilePage.getFieldValue("Permanent Address").should(
      "equal",
      testData.EmployeePersonalData.PermanentAddress
    );

    //Verify that data do not get saved on clicking 'Close' button'
    EmployeeProfilePage.clickOnEditPersonalDetails();
    EmployeeProfilePage.updateDateOfBirth(
      testData.EmployeePersonalData.UpdatedDateOfBirth
    );
    EmployeeProfilePage.updateBloodGroup(
      testData.EmployeePersonalData.BloodGroup2
    );
    EmployeeProfilePage.updateAdhaarNumber(
      testData.EmployeePersonalData.AdhaarNumber2
    );
    EmployeeProfilePage.updateGender(testData.EmployeePersonalData.Gender2);
    EmployeeProfilePage.updatePassportNumber(
      testData.EmployeePersonalData.PassportNumber2
    );
    EmployeeProfilePage.updateMaritalStatus(
      testData.EmployeePersonalData.MaritalStatus2
    );
    EmployeeProfilePage.updatePanNumber(
      testData.EmployeePersonalData.PanNumber2
    );
    EmployeeProfilePage.updateAlternateNumber(
      testData.EmployeePersonalData.AlternateNumber2
    );
    EmployeeProfilePage.updatePermanentAddress(
      testData.EmployeePersonalData.PermanentAddress2
    );
    EmployeeProfilePage.updatePresentAddress(
      testData.EmployeePersonalData.PresentAddress2
    );
    EmployeeProfilePage.clickOnCloseButton();
    ...
    EmployeeProfilePage.getFieldValue("Gender").should(
      "equal",
      testData.EmployeePersonalData.Gender2
    );
    EmployeeProfilePage.getFieldValue("Marital Status").should(
      "equal",
      testData.EmployeePersonalData.MaritalStatus2
    ...
    EmployeeProfilePage.clickOnEditPersonalDetails();
    EmployeeProfilePage.updateDateOfBirth(
      testData.EmployeePersonalData.OriginalDOB
    );
    EmployeeProfilePage.updateBloodGroup(
      testData.EmployeePersonalData.BloodGroup
    );
  ...
  it("HRMIS_4: Verify that the 'Work' accordion expands, and validate the update and close functionalities.", () => {
    ...
    EmployeeProfilePage.getFieldValue("Department").should(
      "equal",
      testData.EmployeeWorkData.Department
    );
    EmployeeProfilePage.getFieldValue("Designation").should(
      "equal",
      testData.EmployeeWorkData.Designation
    );
    EmployeeProfilePage.getFieldValue("Reporting To").should(
      "equal",
      testData.EmployeeWorkData.ReportingTo
    );
    EmployeeProfilePage.getFieldValue("Date of Joining").should(
      "equal",
      testData.EmployeeWorkData.DOJ
    );
    EmployeeProfilePage.getFieldValue("Employee Status").should(
      "equal",
      testData.EmployeeWorkData.EmployeeStatus
    );
    EmployeeProfilePage.getFieldValue("Employee Type").should(
      "equal",
