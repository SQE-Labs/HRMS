...
describe("Attendence Management Punch Details Tests", () => {
    ...
    it("HRMIS_1: Verify Punch Details Page ", () => {
        ...
        PunchDeatilsPage.punchDetailsHeader.should('be.visible').and('have.text', 'Punch Details');
    ...
    it("HRMIS_2: Verify that calendar appears, when user selects an option from 'Select Employee' dropdown field, on 'Punch Details' page", () => {
        ...
        PunchDeatilsPage.calendarDate.should("be.visible").and("have.text", formattedDate);
        PunchDeatilsPage.backwordIcon.should('not.have.class', 'disabled-span').and('be.visible');;
        PunchDeatilsPage.forwordIcon.should('have.class', 'disabled-span').and('be.visible');;
    ...
    it("HRMIS_3: Verify previous month calendar and next month calendar appear after clicking on Backward and Forward Icons respectively ", () => {
        ...
        const { currentMonthOutput, previousMonthOutput } = PunchDeatilsPage.getPreviousMonthAndYear(currentMonth, currentYear);
        ...
        PunchDeatilsPage.calendarDate.should("be.visible").and("have.text", previousMonthOutput);

        PunchDeatilsPage.forwordIcon.click();
        PunchDeatilsPage.calendarDate.should("be.visible").and("have.text", currentMonthOutput);
    ...
    it.only("HRMIS_4: Attendence Details pop up close and open ", () => {
        ...
        PunchDeatilsPage.attendenceDetailHeader.should("be.visible").and("have.text", "Attendance Detail");
