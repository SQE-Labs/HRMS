...
describe("Reimbursement Tests", () => {
  ...
  it("HRMIS_5: Verify Reimbursement Request For Travel Expense ", () => {
    ...
    ReimbursementPage.clickOnSubmit();
    ReimbursementPage.assertValidation(ReimbursementPage.reimbursementType_Drp, "Please select an item in the list.");
    ReimbursementPage.select_reimbursementType(testData.ReimbursementTypes.TravelExpense);
    ...
    ReimbursementPage.clickOnSubmit();
    ReimbursementPage.assertValidation(ReimbursementPage.fromPlaceTxt, "Please fill out this field.");
    ReimbursementPage.enterPlaceName(ReimbursementPage.fromPlaceTxt, "Panipat");

    // To place Validation and Enter the place 
    ReimbursementPage.clickOnSubmit();
    ReimbursementPage.assertValidation(ReimbursementPage.toPlaceTxt, "Please fill out this field.");
    ReimbursementPage.enterPlaceName(ReimbursementPage.toPlaceTxt, "Mohali");


    // Assert Vehical Type validataion and select the type
    ReimbursementPage.clickOnSubmit();
    ReimbursementPage.assertValidation(ReimbursementPage.vehicalTypeDrp, "Please select an item in the list.");
    ReimbursementPage.select_VehicalType(testData.VehicalType.FourWheeler);


    // Distance Validation and Enter the distance 
    ReimbursementPage.clickOnSubmit();
    ReimbursementPage.assertValidation(ReimbursementPage.distanceTxt, "Please fill out this field.");
    ...
    cy.wait(1000);
    ReimbursementPage.clickNextUntilDisabled();
    ReimbursementPage.lastReimbursmentName.should('have.text', testData.ReimbursementTypes.TravelExpense)
    ReimbursementPage.lastInvoiceNo.should('have.text', invoiceNumber);
    ReimbursementPage.lastRowActionLbl.should('have.text', testData.ReimbursementAction.Withdraw);
    ReimbursementPage.lastRequestStatus.should('have.text', testData.ReimbursementStatus.PendingAdmin);
  });
  ...
  it("HRMIS_6: Verify Reimbursement Request For Miscellaneous", () => {
    ...
    ReimbursementPage.clickOnSubmit();
    ReimbursementPage.assertValidation(ReimbursementPage.reimbursementType_Drp, "Please select an item in the list.");
    ReimbursementPage.select_reimbursementType(testData.ReimbursementTypes.Miscellaneous);
    ...
    cy.wait(1000);
    ReimbursementPage.clickNextUntilDisabled();
    ReimbursementPage.lastReimbursmentName.should('have.text', testData.ReimbursementTypes.Miscellaneous)
    ReimbursementPage.lastInvoiceNo.should('have.text', invoiceNumber);
    ReimbursementPage.lastRowActionLbl.should('have.text', testData.ReimbursementAction.Withdraw);
    ReimbursementPage.lastRequestStatus.should('have.text', testData.ReimbursementStatus.PendingAdmin);
  });
